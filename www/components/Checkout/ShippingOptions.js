...
export default ({ shippingAddress, value, setValue }) => {
  ...
  const options = isDomestic ? <>
    ...
    <FormControlLabel value="14.99" control={<Radio />} label="First Class International (No Insurance): $14.99" />
    <FormControlLabel value="34.99" control={<Radio />} label="Priority International (Includes Insurance): $34.99" />
  </>
